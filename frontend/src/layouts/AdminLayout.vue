<template>
  <div class="w-screen h-screen flex bg-gray-100">
    ...
    <div class="card w-[240px] mx-3 my-3 bg-gray-50 drop-shadow-md hidden lg:flex">
      ...
      <h3 class="text-center font-medium uppercase tracking-[.25em] text-gray-500 mb-3">Admin</h3>
      <!-- Menu -->
      <ul class="menu w-56 p-2">
        <li>
          <router-link to="/admin" class="w-full text-center py-4 focus:menu-items" exact-active-class="bg-gray-700 text-slate-100">
            <i class="fa-solid fa-house fa-lg"></i>
            Dashboard
          </router-link>
        </li>
        <li>
          <router-link to="/admin/daftar-pengunjung" class="w-full text-center py-4 focus:menu-items" exact-active-class="bg-gray-700 text-slate-100">
            <i class="fa-solid fa-address-book fa-lg"></i>
              Daftar Pengunjung
          </router-link>
        </li>
        <li class="hover:bg-gray-200 rounded-md">
          <router-link to="/admin/daftar-kunjungan" class="w-full text-center py-4 focus:menu-items" exact-active-class="bg-gray-700 text-slate-100">
            <i class="fa-solid fa-building-circle-check fa-lg"></i>
              Daftar Kunjungan
          </router-link>
        </li>
        <li class="hover:bg-gray-200 rounded-md">
          <router-link to="/admin/daftar-pengguna" class="w-full text-center py-4 focus:menu-items" exact-active-class="bg-gray-700 text-slate-100">
            <i class="fa-solid fa-users fa-lg"></i>
              Daftar Pengguna
          </router-link>
        </li>
        <li class="hover:bg-gray-200 rounded-md">
          <router-link to="/admin/daftar-pelayanan" class="w-full text-center py-4 focus:menu-items" exact-active-class="bg-gray-700 text-slate-100">
